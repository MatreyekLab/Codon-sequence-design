...
samples <- read_sheet("https://docs.google.com/spreadsheets/d/1_JNV3crx33WMexKpFgCle54Ftxx1pqIQAT00_gy120U/edit?usp=sharing", sheet = "NextSeq3") %>% mutate(concentration = as.numeric(as.character(concentration)))
...
amp1_set1$mix_conc <- sum(amp1_set1$dil_ng) / sum(amp1_set1$dil_vol)

amp1_set2$dil_ng <- 50
amp1_set2$dil_vol <- round(amp1_set2$dil_ng / amp1_set2$concentration,2)
amp1_set2$mix_conc <- sum(amp1_set2$dil_ng) / sum(amp1_set2$dil_vol)

amp1_set3$dil_ng <- 100
amp1_set3$dil_vol <- round(amp1_set3$dil_ng / amp1_set3$concentration,2)
amp1_set3$mix_conc <- sum(amp1_set3$dil_ng) / sum(amp1_set3$dil_vol)
...
amp1_mix_volumes <- c(17,3.02,1.04)
